<?php
     ...
     class masyarakat {
       ...
       function tambah(){
        include "koneksi.php";
        $koneksi->query("INSERT INTO `masyaraka` VALUES ('$this->nik','$this->nama','$this->username','$this->password','$this->telp')");
       }
      ...
      $warga = new masyarakat("4321","abdel","abdel21","1234","080808");
      $warga->tambah();
?>
